...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/actility/apis.md
...
- name: ThingPark DX Core API - Downlink message sending
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/actility/devicesdevicedownlinkmessages-post-openapi.md
- name: ThingPark DX Core API - Downlink message sending
  x-api-slug: devicesdevicedownlinkmessages-post
  description: Sends a new downlink message to the device, if that device is within
    authorized scopes. The message is queued in the LRC until the device is able to
