...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/gitlab/apis.md
specificationVersion: "0.14"
apis:
- name: API title - Get Internal Broadcast Message
  x-api-slug: v3internalbroadcast-message-get
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/gitlab/v3internalbroadcast-message-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/gitlab/v3internalbroadcast-message-get-openapi.md
- name: API title - Get Internal Broadcast Message
  x-api-slug: v3internalbroadcast-message-get
  description: Get internal broadcast message.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/githlab-logo.png
