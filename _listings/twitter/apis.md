...
- name: Twitter Create Direct Message
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/twitter/direct-messages-new-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/twitter/direct-messages-new-post-postman.md
x-common:
- type: x-net-library
