...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/plentymarkets/apis.md
...
- name: plentymarkets REST-API - Create a message
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/plentymarkets/restticketsticketid-post-openapi.md
- name: plentymarkets REST-API - Create a message
  x-api-slug: restticketsticketid-post
  description: Creates a message for the ticket. The ID of the ticket must be specified.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/plentymarkets.png
