...
- name: Microsoft Office 365 Add Messages Message Create Reply All
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/microsoft-office-365/messages-message-id-createreplyall-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/microsoft-office-365/messages-message-id-createreplyall-post-postman.md
x-common:
- type: x-developer
