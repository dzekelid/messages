...
- name: Stride
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/messaging/master/_listings/stride/site-cloudid-conversation-conversationid-message-messageid-get.md
x-common:
