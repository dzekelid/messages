...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/chaingenie/apis.md
...
- name: ChainGenie = DLT + Blockchain + Magic - Check message exists on blockchain
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/chaingenie/ethledgerexistsstr-post-openapi.md
- name: ChainGenie = DLT + Blockchain + Magic - Write message to blockchain
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/chaingenie/ethledgerpoststr-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/chaingenie/ethledgerpoststr-post-openapi.md
x-common:
- type: x-github
