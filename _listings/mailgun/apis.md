...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/mailgun/apis.md
...
- name: Mailgun API - Posts Mime Message
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/mailgun/messages-mime-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/mailgun/messages-mime-post-openapi.md
- name: Mailgun API - Send Message
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/mailgun/messages-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/mailgun/messages-post-openapi.md
- name: Mailgun API - Message
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/mailgun/messagesid-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/messages/master/_listings/mailgun/messagesid-get-openapi.md
- name: Mailgun API - Posts Mime Message
  x-api-slug: messages-mime-post
  description: 'Posts a message in MIME format. Note: you will need to build a MIME
    string yourself. Use a MIME library for your programming language to do this.
